const dialogues = {
  ...
  hera: {
    ...
    books: [
      [
        '/assets/books/EllesetleFeu-Hera.jpg',
        `HERA :  Elles et le feu… Ce n’est pas un titre, petit renard, c’est un serment. Chaque femme qu’on a voulu faire taire porte en elle une étincelle. Et moi, Héra, je suis leur flamme souveraine. On me dit jalouse, colérique, mais l’on oublie que je suis la mémoire des injures et la gardienne des serments trahis. Quand les hommes oublient, je rappelle. Et quand ils détruisent, je consume. Voilà pourquoi ce livre me sied : il parle d’elles, donc il parle de moi.  (Eeilos)`,
      ],
      [
        `/assets/books/PenelopeReinedIthaque-Hera.jpg`,
        `HERA : Dans ce livre, je raconte moi-même l’histoire de Pénélope attendant le retour d’Ulysse tout en essayant de repousser les prétendants. L’histoire raconte comment plusieurs femmes grecques mettent tout en œuvre pour échapper à leur destin. Moi-même, je vois à travers Penelope et Clytemnestre les similitudes dans les failles de mon propre mariage. (Maria Materdei)
`,
      ],
      [
        `/assets/books/LasagefemmedAuschwitz-Hera.jpg`,
        `HERA : A nouveau une histoire de Femmes, de Mère, de Sœurs, de gardiennes et de guerrières. Ces femmes qui ont trop souffert mais qui trouveront courage et détermination pour mettre au monde des vies. Peut-être étaient-elles protégées par moi ?  (Maria Materdei)
`,
      ],
      [
        `/assets/books/Circe-Athena.jpg`,
        `HERA : L’histoire d’une femme seule que tout le monde a rejetée mais qui voit dans sa prison une façon de devenir celle qu’elle a toujours voulu être et de s’affranchir de sa condition de nymphe des fleuves pour devenir une Héroïne.  (Maria Materdei)
`,
      ],
    ],
    lines: [
  ...
  athena: {
    ...
    books: [
      [
        '/assets/books/FourthWings-Athena.jpg',
        'ATHENA : Violet est mon portrait parfait car dans les deux tomes de la saga de Rebecca puisqu’elle intègre le cadrant des cavaliers et qu’elle se prépare à la guerre (Asiley)',
      ],
      [
        '/assets/books/Circe-Athena.jpg',
        'ATHENA : Circé est une femme intelligente qui doit ruser pour que les hommes respectent son île et qu/’elle ne soit pas violenté.Elle fabrique également tout elle même grace aux ressources illimitées qu’elle possède. Elle en a aussi vécu des vertes et des pas mûres donc niveau sagesse elle est plutôt bien haha (killumani)',
      ],
    ],
    lines: [
  ...
  poseidon: {
    ...
    books: [
      [
        '/assets/books/Aatea-Poseidon.jpg',
        'POSEIDON :  Aatea... Ce livre est une lame de fond. Il parle comme moi, avec la langue des marées et le souffle des tempêtes. Il connaît la morsure du sel, la violence des ruptures, la beauté cruelle des abysses. Comme moi, il engloutit, il emporte, il détruit pour révéler. Ceux qui s’y aventurent doivent savoir nager dans la douleur, car les eaux d’Aatea, comme les miennes, ne pardonnent pas.  (Rose Darcy)',
      ],
      [
        '/assets/books/LFDDLM-Poseidon.jpg',
        'POSEIDON : Une quête, à la rencontre du dieu de la mer. (Aruhi)',
      ],
    ],
    lines: [
  ...
  ares: {
    ...
    books: [
      [
        '/assets/books/BattleRoyale-Ares.jpg',
        'ARES : Le titre parle de lui-même… Des collégiens kidnappés et envoyés sur une île pour s’entre-tuer jusqu’à ce qu’il n’en reste plus qu’un. Les morts dans le roman sont particulièrement violentes et sanglantes. (LonelyRatGirl)',
      ],
    ],
    lines: [
  ...
  hephaistos: {
    ...
    books: [
      [
        '/assets/books/JeReinventeraiLaPluie-Hephaistos.jpg',
        'HEPHAISTOS : Le personnage principal est souffleur de verre. (Vicky)',
      ],
    ],
    lines: [
  ...
  aphrodite: {
    ...
    books: [
      [
        '/assets/books/LePalaisdEros-Aphrodite.jpg',
        'APHRODITE : Ce livre est une réécriture/reinterpretation du mythe de Éros et Psyché. Dans ce livre Psyché découvre les plaisirs dit interdit de l’homosexualité avec éros qui bien que présenté.e comme non binaire est désignée comme lesbienne. De plus, je suis est un personnage important dans l’histoire. (hana_artiste)',
      ],
      [
        '/assets/books/LesLiaisonsDangereuses-Aphrodite.webp',
        'APHRODITE :  Les Liaisons dangereuses… Voilà un livre qui comprend mon art. Il tisse les désirs comme des pièges, transforme les mots en caresses ou en lames. L’amour y est jeu, pouvoir, manipulation — n’est-ce pas là mon royaume ? Ce roman, c’est mon miroir : séduisant, cruel, et infiniment humain.  (Chaussette)',
      ],
    ],
    lines: [
  ...
  demeter: {
    ...
    books: [
      [
        '/assets/books/LesMurmuresDeLaTerre-Demeter.jpg',
        "DEMETER : Le personnage principal (Alex) fait de la permaculture, c'est une technique d'agriculture qui consiste à protéger les écosystèmes naturels et à récupérer seulement ce que la terre veut bien donner. (Vicky)",
      ],
    ],
    lines: [
  ...
  apollon: {
    ...
    books: [
      [
        '/assets/books/CALLMEBYYOURNAME-Apollon.jpg',
        "APOLLON : L'action du livre se déroule en Italie en plein été donc le soleil est au rendez-vous ! De plus, Elio joue du piano et avec Oliver, ils se rendent dans des lieux culturels, notamment des sites de fouilles archéologiques et la lecture est un élément central du livre. Enfin, j'ai trouvé la plume de l'auteur très poétique, il y a une certaine prose dans son écriture qui est très jolie et qui m'a émue. J'ai l'impression aussi qu'il y a un côté assez prophétique à leur histoire d'amour car cela ne peut pas durer éternellement, seulement le temps d'un été car ce n'est pas le bon moment mais que ce n'est pas fini et que leurs chemins se rencontreront de nouveau pour ne plus jamais se quitter. (noemie)",
      ],
      [
        '/assets/books/LaMaledictiondelOracle-Apollon.jpg',
        "APOLLON : une réécriture du mythe de Cassandre, à qui j'ai attribue le don de dire l’avenir. Ayant refusé mes avances, je l’ai maudit , de sorte que ses prédictions ne soient jamais crues. ( J’ai trop hâte de commencer cette lecture !!, Mama)",
      ],
    ],
    lines: [
  ...
  artemis: {
    ...
    books: [
      [
        '/assets/books/PleinCiel-Artemis.jpg',
        "ARTEMIS : Le personnage principal Ivoire est souvent associé à la lune à cause de son teint pâle ( et d’autres mais spoil ) et c’est même un de ces prénoms, ce livre fait penser à moi car je suis une des trois divinités de la lune et j'ai un très grand lien avec celle-ci. (Yuna)",
      ],
    ],
    lines: [
  ...
  dionysos: {
    ...
    books: [
      [
        '/assets/books/Leprincecruel-Dionysos.jpg',
        'DIONYSOS : Cardan est un personnage qui me ressemble beaucoup. Il aime faire la fête, boire, provoquer les autres et cacher ses vrais sentiments. Il est à la fois séduisant, dangereux et changeant. Comme Dionysos, il cherche sa place en jouant avec les règles. (Mathou)',
      ],
    ],
    lines: [
  ...
  hades: {
    ...
    books: [
      [
        '/assets/books/COLLECTEDREGRETSOFCLOVER-Hades.jpg',
        "HADES : La vie de Clover, protagoniste de l'histoire tourne autour d'une seule chose : la mort. Clover est en effet une doula de fin de vie (ou thanadoula). Alors que je règne sur le royaume des morts avec autorité, Clover, elle, accompagne les mourants et les aide à accepter leur départ. (saly)",
      ],
      [
        '/assets/books/LeGrandvoyage-Hades.jpg',
        'HADES : L’intrigue du livre tourne autour d’une légende bretonne, celle de l’Ankou. L’Ankou vient vous chercher à votre dernier souffle et vous emmène, dans sa charrette, au pays des morts, une sorte de purgatoire. Un jeune garçon et ses amis décident de s’y rendre afin d’y retrouver la mère du personnage principal. C’est un livre jeunesse qui parle de la perte d’un être cher et du deuil des proches. (Hasa)',
      ],
    ],
    lines: [
